...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(23, 23, [1, 1], id="example 4, equal first check under second"),
        pytest.param(24, 24, [2, 2], id="example 5, equal second check"),
        pytest.param(27, 27, [2, 2], id="example 6, equal second check under third"),
        pytest.param(28, 28, [3, 2], id="example 7, equal third check"),
        pytest.param(100, 100, [21, 17], id="example 8, critical big value check"),
    ]
)
